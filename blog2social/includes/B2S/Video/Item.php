        ...
        if (!empty($result) && is_array($result)) {
            ...
            foreach ($result as $var) {
                ...
                if ((int) $var->hook_action == 0) {
                    $content .= '<a href="#" class="b2s-post-video-upload-area-drop-btn" data-attachment-id="' . esc_attr($var->id) . '">';
            ...
            $content .= '<a class="checkbox-post-video-upload-all-btn" data-attachment-id="' . esc_attr($attachment_id) . '" href="#">';
